...
cp {{projectdir}}/AppResults/${line}/Files/${line}.hard-filtered.vcf.gz /home/basecare/Annotation_SPK
...
python3 /home/basecare/Programs/VCF-Simplify-master/VcfSimplify.py SimplifyVCF -toType table -inVCF "${line}.hard-filtered.vcf" -outFile "${line}/${line}.tab"
...
perl /home/basecare/Programs/Annotation_db/convert2annovar.pl -format vcf4old "${line}.hard-filtered.vcf" > "${line}/${line}.avinput"
perl /home/basecare/Programs/Annotation_db/table_annovar.pl "${line}/${line}.avinput" /home/basecare/Programs/Annotation_db/humandb/ -buildver hg19 -out "${line}/${line}_out" -remove -protocol ensGene,avsnp150,clinvar_20190305,intervar_20170202,intervar_20180118,esp6500siv2_all,exac03,gnomad211_exome,1000g2015aug_all,1000g2015aug_SAS,cadd13gt20,dbnsfp35a,dbscsnv11,dbnsfp31a_interpro -operation g,f,f,f,f,f,f,f,f,f,f,f,f,f -nastring .
echo "##########Ending annovar annotation#################"
#preparing config file
echo "##########Starting cancervar annotation#################"
perl /home/basecare/Annotation_SPK/config.pl ${line}/${line}
#running cancervar
python3 /home/basecare/Programs/Annotation_db/CancerVar.py -c config.ini
