...
def cafa():
    ...
    l5 = "   cutadapt -j 30 -m 35 -a " + adapter + " -A " + adapter + \
        " -o ${SAMPLE}_S1_L001_R1_001.fastq.gz -p ${SAMPLE}_S1_L001_R2_001.fastq.gz ${SAMPLE}_R1.fastq.gz ${SAMPLE}_R2.fastq.gz >" + \
        location + "/cutadaptlog" + "/${SAMPLE}_cutadaptlog.txt"
    l6 = "done"
