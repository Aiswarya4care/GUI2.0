...
testchosen['values'] = ( 'TarGT_Absolute','TarGT_Core', 'TarGT_Indiegene', 'TarGT_Focus', 'TarGT_First', 'TarGT_Absolute_Germline',  'Germline_Plus', 'Germline_++','HRR')
...
#RNA QC
rnaqc_btn= tk.Button(window, text = 'RNA Fusion & QC', command = rna_fusion ,height = 1, width = 18) 
